...
Das Package `openxlsx` bietet die Möglichkeit, unterschiedliche Datensätze in mehreren Tabellenblättern in einer xlsx-Datei zu speichern. Hier mal exemplarisch, indem wir den potato-Datensatz mit dem oben generierten Datensatz in zwei Tabellenblättern in einer Datei speichern.

```{r}
wb <- createWorkbook()
addWorksheet(wb, sheetName = "Kartoffeldaten")
writeData(wb, "Kartoffeldaten", md) 
addWorksheet(wb, sheetName = "Alter_Gewicht")
writeData(wb, "Alter_Gewicht", md1) 
