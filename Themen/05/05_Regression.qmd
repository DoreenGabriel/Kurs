...
Mit jedem Anstieg des Ertrag (je dt/ha) sinkt der Proteingehalt um `r round(coef(mod)[2],2)` %. Das R² des Modells beträgt `r round(summary(mod)$r.sq*100,1)`.
