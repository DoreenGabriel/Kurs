...
Weitere tolle Möglichkeiten, um Fakoren zu manuipulieren, bietet die `library(forcats)` [https://forcats.tidyverse.org/](https://forcats.tidyverse.org/){target="_blank"}.  
